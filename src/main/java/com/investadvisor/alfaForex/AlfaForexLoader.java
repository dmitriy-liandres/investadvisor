...
public class AlfaForexLoader extends PammLoader {
    ...
    private static AlfaForexLoader instance = new AlfaForexLoader();
    ...
    public static AlfaForexLoader getInstance() {
        return instance;
    }

    private AlfaForexLoader() {
    }
    ...
    <td class="th_currency_tbody">RUR</td>
        ...
        while (StringUtils.isNotEmpty(response)) {
            ...
            while (managersMather.find()) {
                ...
                //to get invetor money we have to send separate request
